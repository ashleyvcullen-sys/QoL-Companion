...
export const END_OF_LIFE_TOPICS = [
  {
    ...
    content: [
      ...
      { type: 'p', text: 'Other signals worth weighing alongside the QoL score:' },
      { type: 'list', items: [
      ...
      { type: 'p', text: "None of this has to be decided alone — consult with your veterinarian to help guide the decision-making process." },
      { type: 'p', text: "It's also normal to feel like you're deciding 'too early' or 'too late' no matter when you choose — that discomfort doesn't mean the decision is wrong." },
      { type: 'p', text: "It is very common for pet owners to feel guilty and to see euthanasia as 'giving up.' They will therefore often wait until the last minute to make this difficult decision. Unfortunately, in hindsight, many owners regret waiting too long due to the poor quality of life their pet experienced at the end. Waiting too long can also limit control and available options when the time comes to say goodbye — emergency situations and traumatic passings become far more likely. It is far more peaceful to make the decision earlier rather than too late." },
      { type: 'p', text: "This is one of the hardest decisions a pet owner can face — but it's also one of the most selfless and kindest things you can do for them. Choosing to spare your pet from suffering, even when it breaks your heart, is a final act of love." },
    ],
  },
  {
    key: 'natural-death',
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'p', text: "Your vet clinic can usually arrange cremation directly through a local pet crematorium, or point you to a dedicated aftercare provider — it's completely fine to ask about pricing and options in advance, before you need them, so it's one less decision to make in the moment." },
    ],
  },
  {
