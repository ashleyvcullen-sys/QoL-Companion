...
export const BEAP_SCALES = {
  dog: [
    ...
    { key: "ambulation", letter: "A", label: "Mobility (Walking, Stairs & Jumping)", concernFrom: 6, emergencyFrom: 8, levels: [
    ...
    { key: "palpation", letter: "P", label: "Response to Touch", concernFrom: 6, emergencyFrom: 8, levels: [
  ...
  cat: [
    ...
    { key: "ambulation", letter: "A", label: "Mobility (Jumping, Walking & Stairs)", concernFrom: 6, emergencyFrom: 8, levels: [
