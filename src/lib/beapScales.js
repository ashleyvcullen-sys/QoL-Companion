export const BEAP_SCALES = {
  ...
  cat: [
    { key: "breathing", letter: "B", label: "Breathing", levels: [
      "Breathing appears comfortable, calm, and takes minimal effort.",
      "Occasionally breathes a bit faster than usual at rest. Breathing otherwise appears comfortable, calm, and takes minimal effort.",
    ...
    { key: "ambulation", letter: "A", label: "Ambulation (jumping, walking & stairs)", levels: [
      "Jumps and walks normally, manages stairs easily, no obvious stiffness or limping",
      "Occasional hesitation before jumping or using stairs, no obvious stiffness or limping.",
      "Often hesitates to jump or use stairs, occasionally limps and/or looks stiff especially after laying down.",
      "Avoids jumping and stairs, some limping and/or noticeably stiff when walking.",
      "Won't jump or use stairs, noticeable limping and/or moves with marked stiffness. Occasionally licks a painful area.",
      "Unable or unwilling to walk or jump. Often licks or chews a painful area.",
    ] },
    { key: "activity", letter: "A", label: "Activity", levels: [
